<?php 
        $title = 'Cyan Airlines | User Registration'; 
          ...
          <div class="well bs-component">
			<?php  
				...
				if(isset($_GET['success']) && empty($_GET['success'])) {
					echo 'You have been registered to Cyan Airlines successfully! Please check your Email ID for activation link!';
				} 
				else {
...
include $_SERVER["DOCUMENT_ROOT"].'/cyan/includes/overall/footer.php'; ?>  
