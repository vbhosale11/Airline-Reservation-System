<?php 
	...
	require $_SERVER["DOCUMENT_ROOT"].'/cyan/core/database/connect.php';
	require $_SERVER["DOCUMENT_ROOT"].'/cyan/core/functions/general.php';
	require $_SERVER["DOCUMENT_ROOT"].'/cyan/core/functions/users.php';
	...
	if(f_logged_in() === true) {
	      ...
	      if($current_file !== 'changepass.php' && $current_file !== 'logout.php' && $f_data['f_passrec'] == 1) {
	      		header('Location: http://localhost/cyan/changepass.php?force');
	      		exit();
	      }
	}
