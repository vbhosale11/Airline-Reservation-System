<?php
	...
	function register_f($register_data) {
		...
		activation($register_data['f_mailid'], 'Cyan Airlines: Activate your account', "Hello " . $register_data['f_fname'] . ", \n\nYou need to activate your account in order to use the features of Cyan Airlines. Please click the link below: \n\nhttp://srikanthnatarajan.com/cyan/activate.php?f_mailid=" . $register_data['f_mailid'] . "&f_mailcode=" . $register_data['f_mailcode'] . " \n\n-Cyan Airlines");
	}
